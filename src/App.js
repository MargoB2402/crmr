          ...
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 px-3 mb-md-0" style={{ fontSize: "25px" }}>
                ...
                <li class="nav-item">
                  <a class="nav-link" target="blank" href="https://cryptor.store/pages/crmr">About Collection</a>
                </li>
                <li class="nav-item">
        ...
        <div className='container container-style'>
          ...
          <form>
            <div className="row pt-3">
              ...
              <img src="CRYPTORMARE.gif" width="50%" />
              </div>

              <div><label style={{ fontWeight: "300", fontSize: "18px" }}>Select NFT Quantity</label>
            </div>
            <ButtonGroup size="lg"
            ...
            <h6 className="pt-2" style={{ fontFamily: "SF Pro Display", fontWeight: "300", fontSize: "18px" }}>Buy with your preferred crypto (Polygon Matic Mainnet)</h6>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form  style={{ fontFamily: "SF Pro Display" }} >
              <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>CRYPTORVERSE NFT Staking </h2>
                    ...
                    <table className='table px-3 table-bordered table-dark'>
                      ...
                      <tr>
                        ...
                        <tr className='stakegoldeffect'>
                          <td>CryptorMare NFT Collection</td>
                        ...
                        <tr>
                          ...
                          <td class="amount" data-test-id="rewards-summary-ads"><span class="amount">10</span>&nbsp;<span class="currency">CRYPTOR</span>
                          </td>
                        </tr>
